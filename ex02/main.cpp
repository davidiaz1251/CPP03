...
int main()
{
    ...
    // Test FragTrap construction/destruction chaining
    ...
    // Test FragTrap attack (inherited from ClapTrap, not overridden)
    ...
    // Test energy depletion with FragTrap (it has more energy)
    ...
    energyTester.beRepaired(1);
    energyTester.highFivesGuys(); // Special abilities don't cost energy
